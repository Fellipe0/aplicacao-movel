...
public class CNPJUtil {
	...
	public static boolean isValid(String cnpj) {
		if (StringUtil.isNullOrEmpity(cnpj))
			return false;
	...
	public static String unmask(String cnpj) {
		return StringUtil.isNotNullOrEmpity(cnpj) ? cnpj.replaceAll("[./-]", "") : "";
	}

	public static String mask(String cnpj) {
		return StringUtil.isNotNullOrEmpity(cnpj)
				? cnpj.replaceAll("(\\d{2})(\\d{3})(\\d{3})(\\d{4})(\\d{2})", "$1.$2.$3/$4-$5")
				: "";
	}
